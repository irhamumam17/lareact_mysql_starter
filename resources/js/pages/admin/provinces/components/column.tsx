...
function SortHeader({ label, columnKey }: { label: string; columnKey: string }) {
    ...
    return (
        <Link
            href={provinces.index.url({ mergeQuery: { sort: columnKey, direction: nextDirection, page: 1, per_page: currentPerPage || undefined } })}
...
export const columns: ColumnDef<ProvinceModel>[] = [
    {
        accessorKey: "name",
